...
export class ChartService {
    private doughnutLabel = {
        id: 'doughnutlabel',
        beforeDatasetDraw: function (chart: any, args: any, options: any) {
            this.drawDoughnutLabel2(chart, options);
        },
        drawDoughnutLabel2(chart: any, options: any) {
    ...
    createChartForSummary = async (data: DatabaseResult, data2: DatabaseResultForSummary) => {
        ...
        let canvas: Canvas | null = createCanvas(1500, 1000);
        const ctx = canvas.getContext('2d');


        // @ts-ignore
        let myDoughnutChart: Chart | null = new Chart(ctx, {
                type: 'doughnut',
                data: {
                ...
                plugins: [this.plugin, this.doughnutLabel],
            }
        );
    ...
    createChartForStatistics = async (data: { spot: string; amount: number }[], username: string | undefined) => {

        const total = data.reduce((total, obj) => total + obj.amount, 0);

        let canvas: Canvas | null = createCanvas(1500, 800);
        const ctx = canvas.getContext('2d');
        //@ts-ignore
        let myDoughnutChart: Chart | null = new Chart(ctx, {
                type: 'doughnut',
